  ...
  return (
    ...
    items-center justify-center gap-8 mt-4 sm:mt-12 w-[95%] sm:w-[80%]'>
        ...
        <div className='flex items-center space-x-6'>
            ...
            <div>
                <p className='font-medium text-lg mb-[0.2rem]'>Location</p>
                <input type="text" placeholder='Where are you going?'
                 className='outline-none border-none placeholder:text-grey-800' />
            </div>
        </div>
        {/*2nd* search input*/}
        <div className='flex items-center space-x-6'>
           ...
           <div>
            <p className='font-medium text-lg mb-[0.2rem]'>Start Date</p>
            <input type="date" 
                 className='outline-none border-none placeholder:text-grey-800' /> 
           </div>
        </div>
        ...
        <div className='flex items-center space-x-6'>
            <FaCalendarWeek className='w-6 h-6 text-blue-600'/>
           <div>
            <p className='font-medium text-lg mb-[0.2rem]'>End Date</p>
            <input type="date" 
                 className='outline-none border-none placeholder:text-grey-800' /> 
           </div>
        </div>
        ...
        <div className='flex items-center space-x-6'>
            ...
            <div>
            <p className='font-medium text-lg mb-[0.2rem]'>Guest</p>
